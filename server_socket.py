...
class BTCPServerSocket(BTCPSocket):
    ...
    def __init__(self, window, timeout):
        ...
        # Tracking the next sequence number for GBN and also setting this number
        # after the handshake (initial seqNum)
    ...
    def _established_segment_received(self, segment):
        ...
        In this state we:
            - Receive (in-order) segments
            - Send appropriate ACKs
            - Transfer to closing state when FIN is received
